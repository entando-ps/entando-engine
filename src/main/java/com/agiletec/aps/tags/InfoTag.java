...
/**
 * Returns the information of the desired system parameter. Key of the desired system parameter, admitted values
 * are:<br/>
...
public class InfoTag extends ExtendedTagSupport {
    ...
    /**
     * Return the name of the requested system parameter. This value is ignored when the value of the "key" attribute is
     * other than "systemParam"
     *
    ...
    /**
     * Set the name of the requested system parameter. This value is ignored when the value of the "key" attribute is
     * other than "systemParam"
     *
